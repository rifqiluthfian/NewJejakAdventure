...
<div class="container">
    <div class="row justify-content-center"style="padding-top: 12%">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color:#2bb272;">{{ __('Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="no_identity" class="col-md-4 col-form-label text-md-end">{{ __('No Identity (KTP/SIM)') }}</label>
